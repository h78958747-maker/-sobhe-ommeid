...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "relative overflow-hidden px-10 py-6 rounded-[2rem] font-black tracking-widest uppercase text-[12px] transition-all duration-500 ease-out flex items-center justify-center gap-4 disabled:opacity-30 disabled:cursor-not-allowed group active:scale-95 select-none border";
  ...
  return (
    <button 
      ...
      {...props}
    >
      {/* Animated Glow Border - Primary/Secondary only */}
      {variant !== 'gold' && (
