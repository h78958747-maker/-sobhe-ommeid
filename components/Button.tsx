...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-white/5 text-white border-white/10 hover:border-studio-neon/50 hover:bg-studio-neon/5 shadow-lg hover:shadow-studio-neon/20 hover:text-studio-neon hover:shadow-inner-glow",
  ...
  return (
    <button 
      ...
      {...props}
    >
      {/* Subtle Inner Glow Layer (Always present on hover) */}
      <div className="absolute inset-0 rounded-[2rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none shadow-inner-glow-strong"></div>
